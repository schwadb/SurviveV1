...
CATEGORIES = [
    {"id": "medical", "name": "Medical & First Aid", "icon": "🏥",
     "color": "#e74c3c", "desc": "Emergency medicine, first aid, health guides"},
    ...
    {"id": "shelter", "name": "Shelter & Construction", "icon": "🏠",
     "color": "#8e44ad", "desc": "Building techniques, earthships, off-grid structures"},
    {"id": "energy", "name": "Energy & Power", "icon": "⚡",
     "color": "#f39c12", "desc": "Solar, wind, batteries, generators"},
    {"id": "tools", "name": "Tools & Repair", "icon": "🔧",
     "color": "#2980b9", "desc": "iFixit guides, metalwork, woodworking"},
    {"id": "skills", "name": "Practical Skills", "icon": "🪓",
     "color": "#16a085", "desc": "Wilderness survival, fire, navigation, foraging"},
    {"id": "communication", "name": "Communications", "icon": "📡",
     "color": "#c0392b", "desc": "Ham radio, off-grid comms, Morse code"},
